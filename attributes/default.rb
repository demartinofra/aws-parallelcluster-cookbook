...
default['cfncluster']['slurm']['version'] = '20.11.1'
default['cfncluster']['slurm']['url'] = 'https://download.schedmd.com/slurm/slurm-20.11.1.tar.bz2'
default['cfncluster']['slurm']['sha1'] = 'f9d1a66c1019a83d8581dfd991390c9ab5e0c7fe'
# PMIx software
