...
def test_get_request_token(mocker):
    """Test to verify the first step of the authentication process, the retrieval of the Request Token."""
...
def test_check_auth(mocker):
    """
    Test for the DCVAuthenticator._check_auth method.
...
def test_get_session_token(mocker):
    """Test to verify the second step of the authentication process, the retrieval of the Session Token."""
